 ...
 * Date: 2/12/2023
 * Time: 3:54 PM
 * File Name : MaximumGreyness.java
 */
public class MaximumGreyness {
    public static int getMaximumGreyness(List<String> pixels) {
        ...
        int n = pixels.size(), m = pixels.get(0).length();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getMaximumGreyness(Arrays.asList(pixels)));
    }
}
